...
if prompt := st.chat_input("Enter your query"):
    ...
    user_query = model.generate("If "+prompt+" is related to child personality/child developement/ algooru related question then return the number 0 else return 1")
